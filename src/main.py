...
def main():
    ...
    parser.add_argument("--model_name", type=str, default="gcn", help="Which model to use: gcn, gin, gat, sage, transformer, or gine")
    parser.add_argument("--hidden_dim", type=int, default=64)
    parser.add_argument("--epochs", type=int, default=50)
    parser.add_argument("--lr", type=float, default=0.001)
    parser.add_argument("--batch_size", type=int, default=64)
    parser.add_argument("--dropout", type=float, default=0.0, help="Dropout rate")
    parser.add_argument("--activation", type=str, default="relu", help="Activation function: relu, leakyrelu, elu, etc.")
    parser.add_argument("--pool", type=str, default="mean", help="Pooling method: mean, max, attention")
    parser.add_argument("--residual", action="store_true", help="Use residual (skip) connections if set")
    parser.add_argument("--batch_norm", action="store_true", help="Use batch normalization if set")
    parser.add_argument("--heads", type=int, default=4, help="Number of attention heads for GAT/Transformer")
